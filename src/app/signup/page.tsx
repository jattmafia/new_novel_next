...
export const metadata = {
    title: "Sign Up - Webnovel",
    description: "Create your Webnovel account and start reading",
};
                ...
                <div className="w-full max-w-md relative z-10">
                    ...
                    <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-purple-100/50">
                        ...
                        <div className="mb-8 pt-2">
                            <h1 className="text-4xl font-bold bg-linear-to-r from-purple-600 to-amber-600 bg-clip-text text-transparent mb-2">Join us</h1>
